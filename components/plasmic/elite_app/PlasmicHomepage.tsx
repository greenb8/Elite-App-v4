...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: 790nMzYa3hq_/css
...
export type PlasmicHomepage__ArgsType = { coordinatesManual?: any };
...
function PlasmicHomepage__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          coordinatesManual: { lat: 37.7749, lng: -122.4194 }
        },
        Object.fromEntries(
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    getContactsNameAddressOnly: usePlasmicDataOp(() => {
      return {
        sourceId: "iqGjDkwd1n7EuyMgRi2WfY",
        opId: "909c13fa-3759-4bf1-a78f-959c3f211494",
        userArgs: {},
        cacheKey: `plasmic.$.909c13fa-3759-4bf1-a78f-959c3f211494.$.`,
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  <section
                    className={classNames(projectcss.all, sty.section__kLxkf)}
                  >
                    <h1
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__olRyk)}
                  />
                </React.Fragment>
              )}
            </DataCtxReader__>
...
const PlasmicDescendants = {
  root: ["root", "pageLayout", "h1", "text"],
  pageLayout: ["pageLayout", "h1", "text"],
  h1: ["h1"],
  text: ["text"]
} as const;
