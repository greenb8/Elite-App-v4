...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: RfqW25iqlRqe/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: KcAguPIiLXgn/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__iMbMm)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__hSjuM)}
            label={"Open Popover"}
          />
        ),
