...
import Label from "../../Label"; // plasmic-import: ZoWCKZFwA2_k/component
import TextInput from "../../TextInput"; // plasmic-import: 366f1y4e1FAd/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: ES7m9yn3hrXl/component
import Description from "../../Description"; // plasmic-import: N5eG6kfulOMp/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: L-_h5aYOuT3I/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__xV4Cq, {
          [sty.freeBoxiconEnd__xV4CqJyb4K]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__xV4Cq7CWce]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__xV4CqT7Rlu]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___6KK6G, {
            [sty.freeBoxiconStart___6KK6G7CWce]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___6KK6GT7Rlu]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___6Rrer)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___0Xz0W, {
            [sty.freeBoxiconEnd___0Xz0WJyb4K]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___0Xz0W7CWce]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__o7Aqr)}
                role={"img"}
              />
            ),
