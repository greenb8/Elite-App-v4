...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: sj4OuzAd8F99/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ccePh)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wfM7J)}>
            <div
              className={classNames(
                projectcss.all,
