...
import Radio from "../../Radio"; // plasmic-import: napl1fJDhQ9u/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: otCeck_9o7gc/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___0RvJ6)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__fqTKb)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__kpQ4J)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__px9Kr)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
