...
import Checkbox from "../../Checkbox"; // plasmic-import: gpaZQp5eEtUl/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: tuDKlj2Qpbxi/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__rhs94)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__mZaId)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__fHhtd)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__gxraN)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
