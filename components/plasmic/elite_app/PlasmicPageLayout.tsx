...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: XB6I-Pr5xY0M/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: -MYIllg4V5ok/icon
import TransparentLogoSvgIcon from "./icons/PlasmicIcon__TransparentLogoSvg"; // plasmic-import: yjTIM6_GVh_v/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      layout={"side"}
      logoElement={
        <TransparentLogoSvgIcon
          className={classNames(projectcss.all, sty.svg__qB9Hx)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
      ...
      simpleNavTheme={(() => {
        ...
        __composite["customBgColor"] = "var(--token-XQAvrJshfB03)";
        return __composite;
      })()}
      title={"Elite Landscaping Playbook"}
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__jqrlw)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__lt1Ej)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__fgjr0)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__yp8IS)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
