...
import Button from "../../Button"; // plasmic-import: BpB6rPkC0oh7/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: 8KgTuxzj3O8z/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_-6m5gZaalOL9"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__xA9E3)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__mXnHs)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__fjJsX)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__hKmgA)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___8J2I)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
