...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: WK4g8P9wD9QU/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__nZAw)}
                    value={"item1"}
                  />
