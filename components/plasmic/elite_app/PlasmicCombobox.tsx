...
import MenuPopover from "../../MenuPopover"; // plasmic-import: WK4g8P9wD9QU/component
import MenuItem from "../../MenuItem"; // plasmic-import: sj4OuzAd8F99/component
import MenuSection from "../../MenuSection"; // plasmic-import: dHw0cLB9pg46/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: lBqD8FY5lGz3/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__aboou)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__fmOwQ)}>
            <ChevronDownIcon
