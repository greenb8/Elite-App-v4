...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: gpaZQp5eEtUl/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 0d5SkFKCkRNm/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: LM0YLEsoiEOY/icon
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__hvqtU)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__qmD4P)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
