...
import SliderThumb from "../../SliderThumb"; // plasmic-import: mK8wqjgNJuYK/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: uYh1wMQ_wbp8/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__c7Axk)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__o9O8F)}>
        <div
