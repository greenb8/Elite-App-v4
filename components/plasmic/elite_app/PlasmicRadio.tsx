...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: napl1fJDhQ9u/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ud64)}>
        <div className={classNames(projectcss.all, sty.freeBox__zoj2E)} />
      </div>
      {renderPlasmicSlot({
